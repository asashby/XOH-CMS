    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="card card-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{ url('dashboard/area/edit/'.$areaDetail['id'])}}"  name="addArea" id="addArea" >@csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Nombre Área</label>
                        <input type="text" class="form-control" placeholder="Ingrese Nombre" id="areaName" name="areaName" value="{{$areaDetail['name']}}">
                    </div>
                </div>
                <!-- /.card-body -->
